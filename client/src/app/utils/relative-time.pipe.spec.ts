...
describe('RelativeTimePipe', () => {
  [
    { date: new Date(), result: ['now', '1 second ago'] },
    {
      date: new Date(Date.now() - 999),
      result: ['1 second ago', '2 seconds ago'],
    },
    {
    ...
    {
      date: new Date(Date.now() - 59 * 1000),
      result: ['59 seconds ago', '1 minute ago'],
    },
    ...
    {
      date: new Date(Date.now() - 1 * 7 * 24 * 60 * 60 * 1000),
      result: 'last week',
    },
    {
    ...
    {
      date: new Date(Date.now() - 364 * 24 * 60 * 60 * 1000),
      result: '12 months ago',
    },
    {
      date: new Date(Date.now() - 1 * 365 * 24 * 60 * 60 * 1000),
      result: 'last year',
    },
    {
      date: new Date(Date.now() - 5 * 365 * 24 * 60 * 60 * 1000),
      result: '5 years ago',
    },
  ].forEach(({ date, result }) =>
    it(`formats ${date} as ${result}`, () => {
      ...
      if (Array.isArray(result)) {
        expect(result).toContain(pipe.transform(date));
      } else {
